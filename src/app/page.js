...
export default function Home() {
  return (
    <div className="w-screen h-auto flex flex-col bg-primary dark:bg-[#292B32]">
      <div className="flex justify-center">
        <div className="flex flex-col  justify-center ">
          <a className="font-semibold text-2xl p-4 md:flex md:justify-start flex justify-center">
            <span className="border-b-4 border-b-[#738FFF] dark:text-white">
              Sports
            </span>
          </a>
      ...
      <div className="m-0 p-6 md:m-20 md:p-10 bg-gradient-to-b from-[#F9F8FF] to-[#F3F9FF] dark:bg-gradient-to-b dark:from-[#18282A] dark:to-[#221A2C]">
        <div className="flex flex-col justify-center items-center ">
          <h1 className="font-bold md:text-4xl text-2xl items-center p-2 md:p-6 dark:text-white">
